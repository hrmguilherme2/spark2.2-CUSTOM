...
import org.apache.spark.sql.execution.datasources.hbase_elo.Logging
import org.scalatest.{BeforeAndAfterAll, BeforeAndAfterEach, FunSuite}

import org.apache.hadoop.hbase.util.Bytes
import org.apache.spark.sql.execution.datasources.hbase_elo
import org.apache.spark.sql.execution.datasources.hbase_elo.{Bound, ScanRange}
...
class ScanRangeTestSuite  extends FunSuite with BeforeAndAfterEach with BeforeAndAfterAll  with Logging {
  ...
  test("Test orRange 23") {
    implicit val order: Ordering[Array[Byte]] =  hbase_elo.ord//BinaryType.ordering
    val v = ScanRange.or(
