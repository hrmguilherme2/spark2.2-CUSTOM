...
import org.apache.spark.sql.execution.datasources.hbase_elo
import org.apache.spark.sql.execution.datasources.hbase_elo.HBaseResources._
import org.apache.spark.sql.sources.Filter
import org.apache.spark.sql.types.StructType
import org.apache.spark.util.ShutdownHookManager
import org.apache.spark.sql.execution.datasources.hbase_elo.types.SHCDataTypeFactory

private[hbase_elo] case class HBaseRegion(
    override val index: Int,
    start: Option[HBaseType] = None,
    end: Option[HBaseType] = None,
    server: Option[String] = None) extends Partition

private[hbase_elo] case class HBaseScanPartition(
    override val index: Int,
    regions: HBaseRegion,
    scanRanges: Array[ScanRange[Array[Byte]]],
    tf: SerializedTypedFilter) extends Partition

private[hbase_elo] class HBaseTableScanRDD(
  ...
  override def getPartitions: Array[Partition] = {
    ...
    val ps = r.flatMap { x=>
      ...
      val ranges = ScanRange.and(pScan, hbaseFilter.ranges)(hbase_elo.ord)
  ...
  override def compute(split: Partition, context: TaskContext): Iterator[Row] = {
    ...
    val ord = hbase_elo.ord//implicitly[Ordering[HBaseType]]
